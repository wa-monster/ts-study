...
var Crowller = /** @class */ (function () {
    ...
    //获取网页
    Crowller.prototype.getRowHtml = function (url) {
    ...
    //存入文件
    Crowller.prototype.writFile = function (fileContentStr) {
        fs_1.default.writeFileSync(this.filePath, fileContentStr);
    };
    Crowller.prototype.initSpiderProcess = function (analyzer, url) {
        return __awaiter(this, void 0, void 0, function () {
            var html, fileContentStr;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRowHtml(url)];
                    case 1:
                        html = _a.sent();
                        fileContentStr = analyzer.analyze(html, this.filePath);
